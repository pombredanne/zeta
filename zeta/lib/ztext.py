...
class Swiki( Structure ) :
    ...
    attributes = {
        ...
        'sourceurl'   : [ 'sourceurl', 'source', 'source url' ],
    }
    ...
    def validate( self ) :
        ...
        try :
            ...
            if 'sourceurl' in data :
                data['sourceurl'] = unicode( data['sourceurl'] )
        except :
            rc = False
        return rc
...
class Wiki( Structure ) :
    ...
    def commit( self, config, byuser, tz='UTC', attachments=[] ) :
        ...
        attrs = [ 'wikiid', 'pagename', 'wikiurl', 'projectname', 'projectid',
                  'type', 'summary', 'sourceurl', 'tags', 'favorite', 'vote',
                  'text', 'comment' ]
        ...
        if w :
            ...
            if wtype or summary or sourceurl:
                wikicomp.config_wiki( w, wtype=wtype, summary=summary,
            ...
            w = wikicomp.create_wiki( unicode(wikiurl), wtype=wtype, summary=summary,
                                      sourceurl=sourceurl, creator=byuser )
